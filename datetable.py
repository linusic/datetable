...
class DateTable:
    ...
    YuanDan = ("01-01", "01-02")  # from "01-01" to "01-03"  => "01-01", "01-02", "01-03"
    # 春节：1月21日至27日放假调休，共7天。1月28日（星期六）、1月29日（星期日）上班。
    ChunJie = ("01-21", "01-27")
    # 清明节：4月5日放假，共1天。
    QingMing = ("04-05", "04-05")
    ...
    # ZhongQiu = ("09-29", "10-06")
    # GuoQing = ("09-29", "10-06")

    # 特殊情况:
    # 若有重叠, 则可额外添加 逗号并列声明, eg:
    # ZhongQiuGuoQing = (..., ...)
    ZhongQiuGuoQing = ("09-29", "10-06")
...
# dt = DateTable(2023)
# dt.make_to_file("e:/test/1.txt", head=True)
